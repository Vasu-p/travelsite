...
class JourneysControllerTest < ActionController::TestCase
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post :create, journey: { budget: @journey.budget, by: @journey.by, from: @journey.from, name: @journey.name, people: @journey.people, to: @journey.to }
    end
  ...
  test "should update journey" do
    patch :update, id: @journey, journey: { budget: @journey.budget, by: @journey.by, from: @journey.from, name: @journey.name, people: @journey.people, to: @journey.to }
    assert_redirected_to journey_path(assigns(:journey))
  end
