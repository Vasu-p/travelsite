...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { amount: @cost.amount, description: @cost.description, person: @cost.person }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { amount: @cost.amount, description: @cost.description, person: @cost.person }
    assert_redirected_to cost_path(assigns(:cost))
  end
